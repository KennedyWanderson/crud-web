...
function selectComponent(){
  if(visible === 1){
    return <ProductRegister text={"Componentes de Cadastro de produtos"} />
  } else if(visible === 2) {
    return <ProductList text={"Componentes de listagem"}/>
  } else if(visible === 3) {
    return <CategoryRegister text={"Componentes de Cadastro"}/>
  } else {
