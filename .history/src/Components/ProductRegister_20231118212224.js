...
function ProductRegister(props) {
    ...
    useEffect(() => {
        fetch.get("https://di1vlxhcf8.execute-api.us-east-1.amazonaws.com/list-category").then(
            r => {
    ...
    function registerProduct() {
        fetch.post("https://di1vlxhcf8.execute-api.us-east-1.amazonaws.com/create-products", {
            "name": name,
            "price": price,
            "category": category
        }).then(r => {
