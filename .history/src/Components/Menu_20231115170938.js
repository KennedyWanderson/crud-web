...
import { Category, InsertDriveFile, InsertDriveFileOutlined, Inventory, ViewList } from '@mui/icons-material';
...
export default function Menu() {
    ...
    function selectComponent() {
        if (visible === 1) {
            return <ProductRegister text={"Cadastro de produtos"} />
        } else if (visible === 2) {
            return <ProductList text={"Listagem de produtos"} />
        } else if (visible === 3) {
            return <CategoryRegister text={"Cadastro de categoria"} />
        } else {
            return <CategotyList text={"Listagem de categoria"} />
        }
    }
